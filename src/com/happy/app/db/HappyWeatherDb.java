...
import com.happy.app.model.City;
import com.happy.app.model.County;
import com.happy.app.model.Province;
...
public class HappyWeatherDb {
    ...
    /**
     * 获取HappyWeatherDb 的实例
     * @param context
     * @return
     */
    public static synchronized HappyWeatherDb getInstance(Context context){
